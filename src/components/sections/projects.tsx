...
const projects = [
  ...
  },
  {
    ...
    description: "Aplicação de gerenciamento de tarefas com drag-and-drop, colaboração em tempo real e notificações.",
  ...
  },
  {
    ...
    description: "Gerador de conteúdo baseado em IA com templates personalizáveis e integração com APIs de texto.",
  ...
  },
  {
    ...
    description: "Aplicação para rastreamento de portfólio de criptomoedas com gráficos em tempo real e alertas de preço.",
...
export function Projects() {
  ...
  return (
    <section id="projects" className="py-20 md:py-32 bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-purple-900">
      <div className="container max-w-7xl mx-auto px-4">
        ...
        {/* Filtros e Busca */}
        <div className="mb-12 slide-in-up" style={{ animationDelay: '0.2s' }}>
                ...
                >
                  ...
                  <div className="relative p-8">
                    ...
                    <div className="flex gap-4">
                      <Button asChild className="flex-1 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-2xl py-3 font-semibold transition-all duration-300 transform hover:scale-105">
                ...
                >
                  <div className="relative p-6">
                    ...
                    <div className="flex gap-2">
                      <Button asChild size="sm" variant="outline" className="flex-1 rounded-xl hover:bg-blue-50 dark:hover:bg-blue-900/20">
